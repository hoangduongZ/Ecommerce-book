#!/usr/bin/env python3
"""Generate Chapter 03 offline HTML and Graphviz SVG from the Markdown master.
...
SLUG='chapter-03-domain-modeling'
MD=ROOT / f'{SLUG}.md'
OUT=ROOT / f'{SLUG}.html'
ASSETS=ROOT / 'assets' / 'chapter-03'
...
for i,p in enumerate(codeblocks,1):
    ...
    a=soup.new_tag('a',href=f'assets/chapter-03/diagram-{i:02d}.svg',target='_blank',rel='noopener noreferrer',title='Mở sơ đồ SVG')
    img=soup.new_tag('img',src=f'assets/chapter-03/diagram-{i:02d}.svg',alt=f'Sơ đồ kỹ thuật {i:02d}',loading='lazy')
...
'''
page=f'''<!doctype html><html lang="vi"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="color-scheme" content="light dark"><title>Inside E-commerce · Chương 03 — Domain Modeling</title><style>{css}</style></head><body>
<div id="progress"></div><nav><strong>INSIDE E-COMMERCE</strong><small>Volume 1 — Understanding E-commerce<br>Chapter 03 · Domain Modeling</small>
<a class="back" href="chapter-02-ecommerce-business-models.html">← Chương 02: Business Models</a>
...
<main><article><div class="eyebrow">BACKEND ENGINEERING · SYSTEM DESIGN · PRACTICAL DDD</div>{str(soup)}</article><footer>Inside E-commerce · Volume 1 · Chapter 03 · Offline edition</footer></main>
